...
/******/ 	var hotCurrentHash = "64a6b5960b917a1f8f77"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = angular.module('app', [
	    ...
	    __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"angular-messages\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())), 
	    __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"angular-loading-bar\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())), 
	    __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"satellizer\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()))
	]);


	app.config(__webpack_require__(4));
	app.factory('BookmarkFactory', __webpack_require__(5));
	app.directive('passwordMatch', __webpack_require__(6));
	app.controller('MainCtrl', __webpack_require__(7));
	app.controller('AdduserCtrl', __webpack_require__(8));
	app.controller('BookmarkCtrl', __webpack_require__(9));
	app.controller('LoginCtrl', __webpack_require__(10));
	app.controller('LogoutCtrl', __webpack_require__(11));
